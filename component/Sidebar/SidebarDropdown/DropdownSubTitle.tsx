...
function MainSubTitle({
    ...
    return (
        <motion.div
            className={`ml-8 py-1 pl-1 pr-3 flex items-center gap-2 text-gray-600 rounded-tr-full rounded-br-full cursor-pointer select-none hover:bg-gray-200 ${`relative after:content-[''] after:w-[2px] after:h-full after:absolute after:-left-4 after:top-0 after:-translate-x-2/4 after:bg-gray-200`} ${!hasContent
